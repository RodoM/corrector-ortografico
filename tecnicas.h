...
/**
 * Toma una tabla de cambios y a cada palabra se le intercambian las letras adyacentes para generar nuevas sugerencias
 */
...
/**
 * Toma una tabla de cambios y a cada palabra se le inserta una letra del abecedario en cada posicion de la palabra (al principio, entre medio, al final) para generar nuevas sugerencias
 */
...
/**
 * Toma una tabla de cambios y a cada palabra se le elimina una letra para generar nuevas sugerencias
 */
...
/**
 * Toma una tabla de cambios y a cada palabra se le reemplaza una letra por una del abecedario para generar nuevas sugerencias
 */
 ...
 * pertenecen al diccionario y no fueron previamente agregadas, se agregan a la lista de
 * sugerencias validas como una nueva sugerencia separada por un espacio.
 */
